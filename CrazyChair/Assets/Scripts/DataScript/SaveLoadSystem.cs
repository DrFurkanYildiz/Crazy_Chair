...
public static class SaveLoadSystem
{
    ...
    public static void DeleteSaveFile()
    {
        ...
        {
            File.Delete(Directory.GetFiles(Application.persistentDataPath + "/Saves/")[0]);
    ...
    public static bool isHaveLoadFile(string fileName)
    {
        return Directory.GetFiles(Application.persistentDataPath + "/Saves/").Length != 0;
    }
